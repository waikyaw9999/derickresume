...
const items = [
  {
    ...
    title: 'Aurelia',
    type: 'Website',
    description: 'Luxury island resort experience with private villas, wellness, dining, and booking flows.',
    url: 'https://aurelia-two-lake.vercel.app/',
    image: '/aurelia.png',
    imageAlt: 'Aurelia preview',
  },
  {
    slug: 'booka',
    title: 'Booka',
    type: 'Application',
    description: 'Hotel booking with live inventory, secure checkout, and on-page concierge help.',
    url: 'https://booka.juneko.online/',
    image: '/booka.png',
    imageAlt: 'Booka preview',
  },
  {
    slug: 'mydbtool',
    title: 'MyDBTool',
    type: 'Application',
    description: 'Multi-engine database workbench for MongoDB, PostgreSQL, MySQL, and SQL Server (web + Electron).',
    url: 'https://github.com/waikyaw9999/mydbtool',
    image: '/mydbtool.png',
    imageAlt: 'MyDBTool preview',
  },
  {
    slug: 'exacta',
    title: 'Exacta',
